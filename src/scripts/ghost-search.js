  ...
  (function() {
    ...
    _createClass(GhostSearch, [
      ...
      },
      {
        ...
        value: function url() {
          if (
            this.api.resource == "posts" &&
            this.api.parameters.include.match(/(tags|authors)/)
          ) {
      ...
      },
      {
        ...
        value: function checkFormats() {
          if (
            this.api.resource == "posts" &&
            this.api.parameters.fields &&
            _typeof(this.api.parameters.fields) === "object" &&
            this.api.parameters.fields.constructor === Array
          ) {
            for (var i = 0; i < this.api.parameters.fields.length; i++) {
              if (
                (!this.api.parameters.formats.includes(
                  this.api.parameters.fields[i]
                ) &&
                  this.api.parameters.fields[i].match(
                    /(plaintext|mobiledoc|amp)/
                  )) ||
                (this.api.parameters.fields[i] == "html" &&
                  this.api.parameters.formats.length > 0 &&
                  !this.api.parameters.formats.includes("html"))
              ) {
                console.log(
                  this.api.parameters.fields[i] +
                    " is not included in the formats parameter."
                );
              }
            }
          }
      ...
      },
      {
        ...
        value: function checkKeys() {
          ...
          if (
            !this.options.keys.every(function(elem) {
